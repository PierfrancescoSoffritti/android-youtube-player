    ...
    return (
        <section>
            ...
            <div>
                ...
                A lengthier explanation to why you may want to consider using an alternative to the official YouTube player is written <a href="https://medium.com/@soffritti.pierfrancesco/how-to-play-youtube-videos-in-your-android-app-c40427215230" target="_blank" rel="noopener noreferrer">in this Medium post</a>.
            </div>
        </section>
    );
}
