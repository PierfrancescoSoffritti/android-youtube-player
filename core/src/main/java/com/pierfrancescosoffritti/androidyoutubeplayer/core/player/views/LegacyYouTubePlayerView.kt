 ...
 */
internal class LegacyYouTubePlayerView @JvmOverloads constructor(
    context: Context,
    listener: FullscreenListener,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : FrameLayout(context, attrs, defStyleAttr), LifecycleObserver, YouTubePlayerOwner {

    private val mainThreadHandler = Handler(Looper.getMainLooper())
    private var youTubePlayer: YouTubePlayer? = null
    private var isFullScreen = false
    private var defaultPlayerUiController: DefaultPlayerUiController? = null

    private val webViewYouTubePlayer: WebViewYouTubePlayer = WebViewYouTubePlayer(context, listener)
    ...
    init {
        addView(webViewYouTubePlayer, LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT))
    ...
    override fun onEnterFullscreen(view: View, callback: () -> Unit) {
        isFullScreen = true
    ...
    override fun onExitFullscreen() {
        isFullScreen = false
        removeView(findViewById<View>(101))
    }

    override fun getInstance(): YouTubePlayer? = youTubePlayer
    ...
    fun initialize(
        ...
        initialize = {
            webViewYouTubePlayer.initialize({ player ->
