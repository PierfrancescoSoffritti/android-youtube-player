        ...
        <section>
            ...
            <div className="buttons-container">                
                { buttons.map( (item, idx) => 
                    <a key={idx} className="play-store-button" href={item.store} target="_blank" rel="noopener">
            ...
            <div className="buttons-container">
                { buttons.map( (item, idx) => 
                    <a key={idx} className="sample-app-button" href={item.github} target="_blank" rel="noopener">
