    ...
    return (
        <section>
            ...
            <div className="buttons-container">                
                { buttons.map( item => 
                    <a className="play-store-button" href={item.store} target="_blank" rel="noopener noreferrer">
            ...
            <div className="buttons-container">
                { buttons.map( item => 
                    <a className="sample-app-button" href={item.github} target="_blank" rel="noopener noreferrer">
